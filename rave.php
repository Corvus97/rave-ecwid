...
if ($result->merchantAppSettings->env == "false") {
    ...
    $env = "staging";
    $apiLink = "https://api.flutterwave.com/";
} else {
...
<form method="POST" action="https://hosted.flutterwave.com/processPayment.php" id="paymentForm">
    ...
    <!-- Can be card, account, both (optional) -->
    ...
    <input type="hidden" name="successurl" value="https://rave-ecwid.azurewebsites.net/verify.php">
